---
title: "auzeff_PeerCommentary_sghorui_03"
author: "Soumalya"
html:
toc: true
toc-depth: 2
...
> Returning the results as a dataframe is a nice touch! I went a different route and made a short function that would theoretically be more generally applicable. Your presentation is certainly nicer!
...
> It's not necessary for the basic assignment, but it could be good presentation to return all of these boxplots in grid for easier direct comparison.
...
> Looping through each variable is great for presentation, and I really like your color choices! I ran a Shapiro-Wilk test and cho-squared test to check for normality and Poisson distribution, respectively, but I don't think that's actually necessary.
...
> Setting a seed is definitely a good idea!
...
> Again, great presentation! Given how repetitive the code is, did you consider compacting it into a function that you could run for each variable?
...
> I think it'd be helpful to have a short paragraph here answering the final portions of Q6.
...
> Overall, I think that you have a better grip on the different data structures in R than I do, and it is reflected in how compactly and effectively you present your results. There were a few places where the code could have been shortened a bit by making a function, but I know firsthand from this assignment how deceptively simple that can seem, only to then have a bunch of minor things get messed up in the process. Setting a seed is a very good touch - I considered doing it, but I spent a while on a random color function that would have gotten messed up, so I decided against it. Your annotation is also very comprehensive and easy to follow!
