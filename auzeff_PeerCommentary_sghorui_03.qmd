...
> Overall, I think that you have a better grip on the different data structures in R than I do, and it is reflected in how compactly and effectively you present your results. There were a few places where the code could have been shortened a bit by making a function, but I know firsthand from this assignment how deceptively simple that can seem, only to then have a bunch of minor things get messed up in the process. Your annotation is also very comprehensive and easy to follow. Good job!
